...
<head>
    ...
    <TItle>IRIS FORNITURE I COMPROBANTE</TItle>
...
<body>
    ...
    <div class="info_user">
        ...
        <?php
        $sql = "SELECT * FROM comprobante WHERE cod_comprobante = :cod ";
        $query = $conexiondb -> prepare($sql);
        $query -> execute(array(":cod"=>$codigo));
        ...
        <div class="info_envio">
            ...
            <form action="inserta_compra.php" method="GET">
                <input disabled class="nombre" type="text" name="nombre" value="<?php echo $registro['nombre'] ?>">
                <input disabled class="apellido" type="text" name="apellido" value="<?php echo $registro['apellido'] ?>">
                ...
                <input disabled type="text" class="info_adicional" name="info_adicional" placeholder="Información adicional... (Casa, manzana, calle )"><br>
                        ...
                        <p>COMPROBANTE</p>
                            ...
                            <div class="linea_uno">
                                <div class="img_producto">
                                    <img src="<?php echo $registro['img_producto'] ?>" alt="">
                                    <input class="nombre_producto" type="text" name="nombre_prodcuto" value="<?php echo $registro['nombre_producto'] ?>">
                                    <input class="cantidad_producto" type="text" name="cantidad" value="X <?php echo $registro['cantidad_compra'] ?>">
                                </div>
                            </div>
                            
                                <label for="cantidad_compra">Cantidad: </label>
                                <input class="cantidad_compra" type="text" id="cantidad_compra" name="cantidad_compra" value="<?php echo $registro['cantidad_compra'] ?>"><br>
                                <label for="total">Total: </label>
                                <input class="total" readonly type="number" id="total" name="total" value="<?php echo $registro['total'] ?>">
                                ...
                                <?php 
                                    ...
                                    if ($_SESSION['cod_global'] == $admin) {
                                        ...
                                        ?>
                                            <div class="cancelar">
                                                <form action="actualizar_estado.php" method="GET">
                                                    <input hidden type="text" name="nuevo_estado_cancelado" value="3">
                                                    <input hidden type="text" name="codigo_p" value="<?php echo $codigo?>">
                                                    <input class="cancelar_btn" type="submit" name="cancelar" value="Cancelar pedido">
                                                </form>
                                            </div>

                                            <div class="despachar">
                                                <form action="actualizar_estado.php" method="GET">
                                                    <input hidden type="text" name="nuevo_estado_despachado" value="2">
                                                    <input hidden type="text" name="codigo_p" value="<?php echo $codigo?>">
                                                    <input class="despachar_btn" type="submit" name="despachar" value="Despachar pedido">
                                                </form>
                                            </div>
                                        <?php
                                        ...
                                        ?>
                                            ...
                                            <div class="volver">
                                                    <a href="../usuarios/mis_pedidos.php"><input class="volver_btn" type="button" name="volver" value="Volver"></a>
                                            </div>
                                        <?php
                                    }
