...
$usuario_actual = $_SESSION['id_global'];
?>
...
<?php
	...
	$sql_total="SELECT * FROM comprobante WHERE id_user = $usuario_actual";
	...
	$registros=$conexiondb->query("SELECT * from comprobante WHERE id_user = $usuario_actual LIMIT $empieza, $registros")->fetchALL(PDO::FETCH_OBJ);
	?>
					...
					<table class="table table-hover" border="2px">
						...
						<tbody>
							<tr>
								...
								<td><a href="../compras/ver_pedido_confirmado.php ?cod=<?php echo $persona->cod_comprobante?>"><input class="btn btn-success btn-sm" type="button" name="ver" value="Ver"></a></td>
							</tr>
								<?php
								endforeach;
								?>
